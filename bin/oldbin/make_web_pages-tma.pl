...
sub gen_header {
    my $out = "";
    $out .= "<html><head><title>Guitar Hero SPs</title><link href=\"oldstyles.css\" rel=\"stylesheet\" type=\"text/css\" /></head><body>\n";
...
#		   "Guitar Hero III" );
#    my @titles = ( "Guitar Hero III -- DLC" );
    my @titles = ( "Guitar Hero I -- PS2" );

    for my $i ( 0 .. ( scalar @titles - 1 ) ) {
	my $str = join " | ", @{$aa[$i]};
